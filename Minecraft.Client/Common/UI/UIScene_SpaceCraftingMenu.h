...
class UIScene_SpaceCraftingMenu : public UIScene, public IUIScene_SpaceCraftingMenu
{
private:
...
public:
	UIScene_SpaceCraftingMenu(int iPad, void* initData, UILayer* parentLayer);
...
protected:
	...
	virtual void updateTooltips() { IUIScene_SpaceCraftingMenu::UpdateTooltips(); }
};
