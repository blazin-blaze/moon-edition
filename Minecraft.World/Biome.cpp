...
void Biome::staticCtor()
{
	...
	Biome::moon = (new MoonBiome(23))->setColor(0x2c4205)->setName(L"Moon")->setLeafColor(0xFA9418)->setTemperatureAndDownfall(2, 0)->setDepthAndScale(-0.1f, 0.1f)->setLeafFoliageWaterSkyColor(eMinecraftColour_Grass_Desert, eMinecraftColour_Foliage_Desert, eMinecraftColour_Water_JungleHills, eMinecraftColour_Sky_JungleHills)->setNoRain();
}
