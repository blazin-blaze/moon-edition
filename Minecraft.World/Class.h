...
enum eINSTANCEOF
{
	...
	eTYPE_MOB		= eTYPE_LIVINGENTITY | BIT_MOB,
			...
			eTYPE_PATHFINDER_MOB	= eTYPE_MOB | BIT_PATHFINDER_MOB,
					...
					eTYPE_MONSTER     =	eTYPE_ENEMY | eTYPE_PATHFINDER_MOB | BIT_MONSTER,
						...
						eTYPE_EVOLVEDSKELETON = eTYPE_MONSTER | eTYPE_VALID_IN_SPAWNER_FLAG | 0x9,
	...
	eTYPE_BUGGY = (eTYPE_OTHER_ENTITIES + 16),
	
	// === PARTICLES === //

	eType_BREAKINGITEMPARTICLE,
	eType_BUBBLEPARTICLE,
	eType_OILBUBBLEPARTICLE,
	...
	eTYPE_TILEENTITY						= BIT_TILE_ENTITY,
		...
		//eTYPE_OXYGENATORTILEENTITY = eTYPE_TILEENTITY | 0x12,
...
#define SUBCLASS(x) (new SubClass( #x , x ))
	...
	static void checkDerivations()
	{
		...
		classes->push_back(SUBCLASS(eType_OILBUBBLEPARTICLE)->addParent(eTYPE_ENTITY));
		...
		classes->push_back(SUBCLASS(eType_FIERYSMOKEPARTICLE)->addParent(eTYPE_ENTITY));
		...
		classes->push_back(SUBCLASS(eType_OILSPLASHPARTICLE)->addParent(eTYPE_ENTITY));
		...
		classes->push_back(SUBCLASS(eType_OILDROPPARTICLE)->addParent(eTYPE_ENTITY));
