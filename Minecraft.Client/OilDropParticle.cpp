...
OilDropParticle::OilDropParticle(Level* level, double x, double y, double z) : Particle(level, x, y, z, 0, 0, 0)
{
    xd *= 0.3f;
    ...
    gCol = 1.0f;
    bCol = 1.0f;
    setMiscTex(16*11 + 3 + random->nextInt(4));
