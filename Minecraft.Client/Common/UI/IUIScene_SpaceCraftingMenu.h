#pragma once
#include "..\..\..\Minecraft.World\SpaceRecipy.h"
#include "..\..\..\Minecraft.World\Item.h"

class LocalPlayer;

// 4J Stu - Crafting menu code that's shared across Iggy and XUI
class IUIScene_SpaceCraftingMenu
{
protected:
...
#define DISPLAY_MAX 3
	...
	static const int m_iMaxGroup3x3 = 4;
	...
	static SpaceRecipy::_eGroupType m_GroupTypeMapping9GridA[m_iMaxGroup3x3];
	SpaceRecipy::_eGroupType* m_pGroupA;
...
public:
	SpaceRecipy::_eGroupType getCurrentGroup() { return m_pGroupA[m_iGroupIndex]; }
