...
const int InventoryMenu::SPACE_SLOT_START = InventoryMenu::ARMOR_SLOT_END;
const int InventoryMenu::SPACE_SLOT_END = InventoryMenu::SPACE_SLOT_START + 4;
const int InventoryMenu::INV_SLOT_START = InventoryMenu::SPACE_SLOT_END;
