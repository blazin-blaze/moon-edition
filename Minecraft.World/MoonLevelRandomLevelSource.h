...
class MoonLevelRandomLevelSource : public ChunkSource
{
public:
...
public:
	MoonLevelRandomLevelSource(Level* level, int64_t seed, bool generateStructures);
	~MoonLevelRandomLevelSource();
