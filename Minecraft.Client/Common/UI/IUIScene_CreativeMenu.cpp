...
void IUIScene_CreativeMenu::staticCtor()
{
	...
	DEF(eCreativeInventory_BuildingBlocks)
		...
		ITEM(Tile::sapphireBlock_Id)
		ITEM(Tile::titaniumBlock_Id)
		ITEM(Tile::copperBlock_Id)
		ITEM(Tile::tinBlock_Id)
		ITEM(Tile::aluminiumBlock_Id)
		ITEM(Tile::siliconBlock_Id)
		...
		ITEM(Tile::quartzFenceGate_Id)
		ITEM(Item::door_wood_Id)
		ITEM(Item::door_iron_Id)
		ITEM(Item::quartzDoor_Id)
...
//		ITEM_AUX(Tile::stoneSlabHalf_Id,StoneSlabTile::WOOD_SLAB)
		...
		ITEM(Tile::moonTurf_Id)
		ITEM(Tile::moonDirt_Id)
		ITEM(Tile::moonStone_Id)
		ITEM_AUX(Tile::cobblestone_Id, 1)
		ITEM(Tile::moonQuartzOre_Id)
		ITEM(Tile::sapphireOre_Id)
		ITEM(Tile::titaniumOre_Id)
		ITEM(Tile::cheeseOre_Id)
		ITEM(Tile::copperOre_Id)
		ITEM(Tile::tinOre_Id)
		ITEM(Tile::aluminiumOre_Id)
		ITEM(Tile::siliconOre_Id)
		ITEM(Tile::moonDungeonBricks_Id)
		ITEM(Tile::moonDungeonMossyBricks_Id)
		ITEM(Tile::moonDungeonCrackedBricks_Id)
	...
	DEF(eCreativeInventory_Decoration)
		...
		ITEM(Tile::torch_Id)
		ITEM(Tile::glowstoneTorch_Id)
		ITEM(Tile::deadTorch_Id)
	...
	DEF(eCreativeInventory_Transport)
		...
		ITEM(Item::boat_Id)
		ITEM(Item::rocket_Id)
		ITEM(Item::noseCone_Id)
		ITEM(Item::rocketFins_Id)
		ITEM(Item::rocketEngine_Id)
		ITEM(Item::buggy_Id)
		ITEM(Item::buggySeat_Id)
		ITEM(Item::buggyWheel_Id)
		ITEM(Item::buggyStorage_Id)
		ITEM(Item::buggyBlueprint_Id)
	...
	DEF(eCreativeInventory_Misc)
		...
		ITEM(Tile::spaceWorkbench_Id)
		//ITEM(Tile::oxygenator_Id)
		...
		ITEM(Item::oilBucket_Id)
		ITEM(Item::tinCanister_Id)
		ITEM(Item::fuelCanister_Id)
		...
		ITEM_AUX(Item::spawnEgg_Id, 121); // Lunar Friend
		ITEM_AUX(Item::spawnEgg_Id, 122); // Evolved Zombie
		ITEM_AUX(Item::spawnEgg_Id, 123); // Evolved Skeleton
		ITEM_AUX(Item::spawnEgg_Id, 124); // Evolved Spider
	...
	DEF(eCreativeInventory_Food)
		...
		ITEM(Item::cheese_Id)
		ITEM(Tile::cheeseBlock_Id)
		ITEM(Item::poutine_Id)
		ITEM(Item::cheeseburger_Id)
		ITEM(Item::dehydratedApple_Id)
		ITEM(Item::dehydratedCarrot_Id)
		ITEM(Item::dehydratedMelon_Id)
		ITEM(Item::dehydratedPotato_Id)
		ITEM(Item::cannedBeef_Id)
	...
	DEF(eCreativeInventory_ToolsArmourWeapons)
		...
		ITEM(Item::shears_Id)
		ITEM(Item::sapphireHelmet_Id)
		ITEM(Item::sapphireChestplate_Id)
		ITEM(Item::sapphireLeggings_Id)
		ITEM(Item::sapphireBoots_Id)
		ITEM(Item::sapphireSword_Id)
		ITEM(Item::sapphireShovel_Id)
		ITEM(Item::sapphirePickaxe_Id)
		ITEM(Item::sapphireHatchet_Id)
		ITEM(Item::sapphireHoe_Id)

		ITEM(Item::clock_Id)
		ITEM(Item::titaniumHelmet_Id)
		ITEM(Item::titaniumChestplate_Id)
		ITEM(Item::titaniumLeggings_Id)
		ITEM(Item::titaniumBoots_Id)
		ITEM(Item::titaniumSword_Id)
		ITEM(Item::titaniumShovel_Id)
		ITEM(Item::titaniumPickaxe_Id)
		ITEM(Item::titaniumHatchet_Id)
		ITEM(Item::titaniumHoe_Id)

		ITEM(Item::frequencyModule_Id)
		ITEM(Item::oxygenMask_Id)
		ITEM(Item::oxygenGear_Id)
		ITEM(Item::oxygenTank_Id)
	...
	DEF(eCreativeInventory_Materials)
		...
		ITEM(Item::sapphire_Id)
		ITEM(Item::rawSilicon_Id)
		ITEM(Item::ironIngot_Id)
		ITEM(Item::goldIngot_Id)
		ITEM(Item::copperIngot_Id)
		ITEM(Item::tinIngot_Id)
		ITEM(Item::aluminiumIngot_Id)
		ITEM(Item::titaniumIngot_Id)
		ITEM(Item::compressedIron_Id)
		ITEM(Item::compressedCopper_Id)
		ITEM(Item::compressedTin_Id)
		ITEM(Item::compressedAluminium_Id)
		ITEM(Item::compressedBronze_Id)
		ITEM(Item::compressedSteel_Id)
		ITEM(Item::compressedHeavyDuty_Id)
		ITEM(Item::basicWafer_Id)
		ITEM(Item::advancedWafer_Id)
		//ITEM(Item::oxygenVent_Id)
		//ITEM(Item::oxygenFan_Id)
		//ITEM(Item::oxygenConcentrator_Id)
		...
		ITEM(Item::bone_Id)
		ITEM(Item::string_Id)
		ITEM_AUX(Item::string_Id, StringItem::GREEN)
